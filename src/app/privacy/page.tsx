      ...
      <article className="prose prose-invert prose-headings:scroll-mt-24">
        ...
        <nav aria-label="Sumário" className="not-prose my-6 rounded-xl border p-4">
          ...
          <ul className="mt-3 list-disc pl-5 marker:text-current">
            ...
            <li><a href="#uso-dos-dados">Como Utilizamos os Dados</a></li>
            <li><a href="#cookies">Cookies e Tecnologias Semelhantes</a></li>
            <li><a href="#compartilhamento">Compartilhamento com Terceiros</a></li>
            <li><a href="#direitos">Seus Direitos</a></li>
            <li><a href="#seguranca">Segurança</a></li>
            <li><a href="#retencao">Retenção e Eliminação</a></li>
            <li><a href="#transferencia">Transferência Internacional</a></li>
            <li><a href="#menores">Crianças e Adolescentes</a></li>
        ...
        <ul>
          <li>
            <strong>Conta:</strong> nome, e-mail, credenciais (armazenadas de forma
            segura — não guardamos senhas em texto puro).
          </li>
          <li>
        ...
        <h2 id="bases-legais">2. Bases Legais (LGPD)</h2>
        <p>
        ...
        <h2 id="uso-dos-dados">3. Como Utilizamos os Dados</h2>
        <ul>
        ...
        <h2 id="cookies">4. Cookies e Tecnologias Semelhantes</h2>
        <p>
        ...
        <p>
          ...
          os dados pessoais. Nenhum método é 100% seguro; recomendamos o uso de
          senhas fortes e a não reutilização de credenciais.
        </p>

        <h2 id="retencao">8. Retenção e Eliminação</h2>
        <p>
          Mantemos dados apenas pelo tempo necessário para cumprir as finalidades
          informadas e obrigações legais. Após esse período, eliminamos ou
          anonimizamos conforme a legislação aplicável.
        </p>

        <h2 id="transferencia">9. Transferência Internacional</h2>
        <p>
          Serviços de terceiros podem operar fora do Brasil. Nesses casos,
          adotamos salvaguardas adequadas, conforme exigido pela LGPD.
        </p>

        <h2 id="menores">10. Crianças e Adolescentes</h2>
        <p>
        ...
        <p>
          ...
          em <a href="mailto:privacidade@exemplo.com">privacidade@exemplo.com</a>.
        </p>
